...
func createDarc(cdb byzcoin.CollectionView, darcID darc.ID, pub kyber.Point) (d *darc.Darc, sc byzcoin.StateChange, err error) {
...
func createCoin(cdb byzcoin.CollectionView, inst byzcoin.Instruction, d *darc.Darc, pub kyber.Point, balance uint64) (sc byzcoin.StateChange, err error) {
	iid := sha256.New()
